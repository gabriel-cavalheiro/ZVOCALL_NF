		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Envio NF",
									"targetURL": "#brcominbettazvocallnf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcominbettazvocallnf-display": {
								"semanticObject": "brcominbettazvocallnf",
								"action": "display",
								"description": "App para EN",
								"title": "Envio NF",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.inbetta.zvocallnf",
									"url": sap.ui.require.toUrl("br/com/inbetta/zvocallnf")
								}
							}
						}
					}
